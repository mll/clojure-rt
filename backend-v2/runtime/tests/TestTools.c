...
/* struct UnitTestGroup perfromanceTestGroup(int repeats, int maxSize, void (*test)(void **)) { */
  
    
/* } */

static RegressionResults calculateLinearRegression(int *x, double *y, size_t n) {
