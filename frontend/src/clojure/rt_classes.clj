...
'{java.lang.Object
  ...
  {:static-fns
   {add   [{:args [:double :double] :type :intrinsic :symbol "FAdd"         :returns :double}
           ...
           {:args [:any :any]       :type :call      :symbol "add"          :returns :any}]
  ...
  {:instance-fns
   {asTransient [{:args [:this] :type :call :symbol "PersistentVector_transient" :returns clojure.lang.PersistentVector}]
    persistent [{:args [:this] :type :call :symbol "PersistentVector_persistent_BANG_" :returns clojure.lang.PersistentVector}]
    conj [{:args [:this :any] :type :call :symbol "PersistentVector_conj_BANG_" :returns clojure.lang.PersistentVector}]
    assoc [{:args [:this :int :any] :type :call :symbol "PersistentVector_assoc_BANG_" :returns clojure.lang.PersistentVector}]
    pop [{:args [:this] :type :call :symbol "PersistentVector_pop_BANG_" :returns clojure.lang.PersistentVector}]}}
