...
static void setup_mock_runtime(rt::ThreadsafeCompilerState &compState) {
  // 1. Numbers class for arithmetic
  {
    ...
    gteId.argTypes = {ObjectTypeSet(integerType, false),
                      ObjectTypeSet(integerType, false)};
    ...
    addIBId.argTypes = {ObjectTypeSet(integerType, false),
    ...
    addBIId.argTypes = {ObjectTypeSet(bigIntegerType, false),
                        ObjectTypeSet(integerType, false)};
    ...
    addBBId.argTypes = {ObjectTypeSet(bigIntegerType, false),
                        ObjectTypeSet(bigIntegerType, false)};
    ...
    addRRId.argTypes = {ObjectTypeSet(ratioType, false),
                        ObjectTypeSet(ratioType, false)};
    ...
    gteBBId.argTypes = {ObjectTypeSet(bigIntegerType, false),
                        ObjectTypeSet(bigIntegerType, false)};
...
static void test_bigint_arithmetic_getType(void **state) {
  ...
  ASSERT_MEMORY_ALL_BALANCED({
    ...
    arg1->mutable_subnode()->mutable_const_()->set_type(
        ConstNode_ConstType_constTypeNumber);
    arg1->mutable_subnode()->mutable_const_()->set_val(
        "100000000000000000000"); // BigInt
