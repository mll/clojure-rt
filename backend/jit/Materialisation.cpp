...
ClojureASTMaterializationUnit::ClojureASTMaterializationUnit(ClojureASTLayer &L, unique_ptr<FunctionJIT> F) : MaterializationUnit(L.getInterface(*F)), L(L), F(move(F)) {}
