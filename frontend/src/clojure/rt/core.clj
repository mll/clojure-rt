...
(defn -main
  ([infile] (let [parts (split infile #"\.")]
              (compile (slurp "resources/rt-protocols.edn") "../backend/rt-protocols.cljb" "rt-protocols.edn")
              (compile (slurp "resources/rt-classes.edn") "../backend/rt-classes.cljb" "rt-classes.edn")
              (compile (slurp "resources/rt-classes-extension.clj") "../backend/rt-classes-extension.cljb" "rt-classes-extension.clj")
