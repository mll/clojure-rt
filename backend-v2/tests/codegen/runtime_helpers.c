...
// Use absolute path for system string.h to avoid shadowing by project's String.h on macOS case-insensitive filesystem.
...
// Define RT_NO_STRING_H to prevent RTValue.h from including <string.h> (and finding the local String.h)
