...
/*     LoadInst* cachedTag = builder.CreateLoad(PointerType::getUnqual(ctx), slotAddr); */
...
/*     Value* cacheSlotAddr = builder.getInt64(reinterpret_cast<uintptr_t>(cacheSlot)); */

/*     // 1. Pobierz aktualną funkcję z Var (może być redefiniowana) */
/*     Value* currentFnObj = builder.CreateLoad(PointerType::getUnqual(ctx), varPtr, "current_fn_obj"); */

/*     // 2. Pobierz dane z cache */
/*     Value* cachedFnObj = builder.CreateLoad(PointerType::getUnqual(ctx), cacheSlotAddr, "cached_fn_obj"); */

/*     Value* isHit = builder.CreateICmpEQ(currentFnObj, cachedFnObj, "is_call_hit"); */
...
/*     Value* codePtrAddr = builder.CreatePtrAdd(cacheSlotAddr, builder.getInt64(8)); */
/*     Value* cachedCode = builder.CreateLoad(PointerType::getUnqual(ctx), codePtrAddr, "cached_code"); */
    
/*     // Rzutowanie na sygnaturę funkcji i wywołanie */
/*     FunctionType* fnSig = FunctionType::get(builder.getInt64Ty(), { /\* typy argumentów *\/ }, false); */
...
/*     Value* resultSlow = builder.CreateCall(updateFunc, {currentFnObj, cacheSlotAddr, ...args}); */
/*     builder.CreateBr(exitBlock); */
...
/* extern  "C" int64_t runtime_update_cache(Object* obj, InlineCacheSlot* slot, const char* name) { */
